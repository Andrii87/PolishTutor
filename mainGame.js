    ...
    var WordSpoken2 =false;
		...
		*/
		...
		myCanvas.font = "48px Calibri";
		myCanvas.fillText('Polish tutor',140, 200);
		...
		myCanvas.font = "24px Calibri";
		myCanvas.fillText('F11 for full screen',160, 370);
		myCanvas.save();
		...
		myCanvas.font = "18px Calibri";
		myCanvas.fillText(('current page is: '+DictPage),160, 500);

		myCanvas.font = "18px Calibri";
		myCanvas.fillText(('current chapter is: '+ ChapterNr),160, 530);  
		...
		document.onkeydown = function(event) {
			...
			if ((TryAgainScreen==true)&&(event.keyCode ==69)) { GoToYoutubeEnglish(); }//Y
		}
	...
	youWon = function(){
					...
					myCanvas.fillText('Press Y/E to wach a cartoon (Polish / English)', 100, 500);//will fire GoToYoutube function
					DictPage++;
					pageChanged=true;
					myCanvas.restore();
					win.play();
...
textSpeak = function(){
              ...
              
    {
        ...
        responsiveVoice.speak(currentWord, "Polish Female");
        WordSpoken = true;
    }
    if ((wordY>150) && (WordSpoken2==false))
    {
        console.log("inside textSpeak2 function");
                   
        responsiveVoice.speak(currentWord, "Polish Male");
        WordSpoken2 = true;
    }
}